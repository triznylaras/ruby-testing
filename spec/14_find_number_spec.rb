...
describe FindNumber do
  ...
  describe '#make_guess' do
    ...
    context 'when min is 5 and max is 9' do
      subject { described_class.new(5, 9, number_guessing) }
      it 'returns 7' do
        expect(subject.make_guess).to eq(7)
      end
    end
    ...
    context 'when min is 0 and max is 3' do
      subject { described_class.new(0, 3, number_guessing) }
      it 'returns 1' do
    ...
    context 'when min and max both equal 3' do
      subject { described_class.new(3, 3, number_guessing) }
      it 'returns 3' do
  ...
  describe '#game_over?' do
    context 'when guess and random_number are equal' do
      ...
      let(:guess_number) { double('random_number', value: 5) }
      subject(:game_one) { described_class.new(0, 9, guess_number, 5) }

      it 'is game over' do
        expect(game_one.game_over?).to be true
      end
    end
    ...
    context 'when guess and random_number are not equal' do
      let(:guess_number) { double('random_number', value: 5) }
      subject { described_class.new(0, 9, guess_number, 3) }
  ...
  describe '#update_range' do
    ...
    context 'when the guess is less than the answer' do
      ...
      it 'updates min to 5' do
        expect(low_guess_game.min).to eq(low_guess_game.guess + 1)
      end
    ...
    context 'when the guess is more than the answer' do
      ...
      it 'updates max to 8' do
        expect(high_guess_game.max).to eq(high_guess_game.guess - 1)
      end
    end
    ...
    context 'when the guess is 7, min=5, and max=8' do
      subject { described_class.new(5, 8, number_range, 7) }
